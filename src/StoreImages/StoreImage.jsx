...
export function ShareIcon() {
  return (
    <svg
      ...
      xmlns="http://www.w3.org/2000/svg"
    >
      <circle cx="22.5" cy="22.5" r="22.5" fill="#FBEEF0" />
      <g clipPath="url(#clip0_226_5006)">
        <path
          d="M30.771 18.7267C29.0455 18.7267 27.5069 17.9045 26.5227 16.6337L18.2814 21.2371C18.4745 21.7915 18.5804 22.3895 18.5804 23.0062C18.5804 23.6292 18.4745 24.2209 18.2751 24.7816L26.5102 29.3787C27.4882 28.1017 29.033 27.2733 30.7648 27.2733C33.7174 27.2733 36.1281 29.6777 36.1281 32.6366C36.1281 35.5955 33.7237 38 30.7648 38C27.8059 38 25.4014 35.5955 25.4014 32.6366C25.4014 32.0137 25.5073 31.4157 25.7066 30.8613L17.4778 26.2641C16.4998 27.5473 14.955 28.3696 13.2232 28.3696C10.2706 28.3696 7.85986 25.9651 7.85986 23.0062C7.85986 20.0473 10.2706 17.6429 13.2295 17.6429C14.9612 17.6429 16.506 18.4713 17.4903 19.7546L25.7253 15.1512C25.526 14.5905 25.4139 13.9863 25.4139 13.3634C25.4139 10.4107 27.8183 8 30.7772 8C33.7361 8 36.1406 10.4045 36.1406 13.3634C36.1406 16.3223 33.7299 18.7267 30.771 18.7267ZM30.771 36.3119C32.8017 36.3119 34.4525 34.6611 34.4525 32.6304C34.4525 30.5997 32.8017 28.9489 30.771 28.9489C28.7403 28.9489 27.0895 30.5997 27.0895 32.6304C27.0895 34.6611 28.7465 36.3119 30.771 36.3119ZM13.2295 19.3248C11.1987 19.3248 9.54799 20.9755 9.54799 23.0062C9.54799 25.037 11.1987 26.6877 13.2295 26.6877C15.2602 26.6877 16.9109 25.037 16.9109 23.0062C16.9109 20.9755 15.254 19.3248 13.2295 19.3248ZM30.771 9.68812C28.7403 9.68812 27.0895 11.3389 27.0895 13.3696C27.0895 15.4003 28.7403 17.0511 30.771 17.0511C32.8017 17.0511 34.4525 15.4003 34.4525 13.3696C34.4525 11.3389 32.8017 9.68812 30.771 9.68812Z"
          fill="#CA2543"
        />
      </g>
      <defs>
        <clipPath id="clip0_226_5006">
          <rect
            width="30"
            height="30"
            fill="white"
            transform="matrix(1 0 0 -1 7 38)"
          />
        </clipPath>
      </defs>
    </svg>
...
export function LogoutIconMobileScreen() {
  return (
    <svg width="18" height="18" viewBox="0 0 18 18" fill="none" xmlns="http://www.w3.org/2000/svg">
      <rect width="18" height="18" fill="white" />
      <path d="M12.6 1.5H10.65C8.25 1.5 6.75 3 6.75 5.4V8.4375H11.4375C11.745 8.4375 12 8.6925 12 9C12 9.3075 11.745 9.5625 11.4375 9.5625H6.75V12.6C6.75 15 8.25 16.5 10.65 16.5H12.5925C14.9925 16.5 16.4925 15 16.4925 12.6V5.4C16.5 3 15 1.5 12.6 1.5Z" fill="#CA2543" />
      <path d="M3.42008 8.43738L4.97258 6.88488C5.08508 6.77238 5.13758 6.62988 5.13758 6.48738C5.13758 6.34488 5.08508 6.19488 4.97258 6.08988C4.75508 5.87238 4.39508 5.87238 4.17758 6.08988L1.66508 8.60238C1.44758 8.81988 1.44758 9.17988 1.66508 9.39738L4.17758 11.9099C4.39508 12.1274 4.75508 12.1274 4.97258 11.9099C5.19008 11.6924 5.19008 11.3324 4.97258 11.1149L3.42008 9.56238H6.75008V8.43738H3.42008Z" fill="#CA2543" />
    </svg>
  )
}
export function ContactIcon() {
  return (
    ...
    <svg width="18" height="18" viewBox="0 0 18 18" fill="none" xmlns="http://www.w3.org/2000/svg">
      <path d="M8.71738 10.6124C7.51513 9.62384 6.71238 8.40398 6.29035 7.70988L5.97555 7.1164C6.08562 6.9983 6.92502 6.09947 7.28877 5.61178C7.74589 4.99939 7.08313 4.44631 7.08313 4.44631C7.08313 4.44631 5.21825 2.58118 4.79325 2.21121C4.36824 1.84072 3.879 2.04649 3.879 2.04649C2.98574 2.62365 2.05971 3.12545 2.00415 5.53875C2.00208 7.7982 3.71726 10.1286 5.57204 11.9328C7.42979 13.9703 9.98048 16.0124 12.4465 16.0101C14.8595 15.955 15.3612 15.0291 15.9384 14.1359C15.9384 14.1359 16.1443 13.647 15.7742 13.2216C15.4038 12.7964 13.5384 10.9311 13.5384 10.9311C13.5384 10.9311 12.9857 10.2682 12.3732 10.7257C11.9167 11.0669 11.097 11.8259 10.8995 12.0099C10.8999 12.0106 9.52867 11.2796 8.71738 10.6124Z" fill="#CA2543" />
    </svg>
  )
}
export function InternetIcon() {
  return (
    <svg width="18" height="18" viewBox="0 0 18 18" fill="none" xmlns="http://www.w3.org/2000/svg">
      <path fill-rule="evenodd" clip-rule="evenodd" d="M9 2C5.15 2 2 5.15 2 9C2 12.85 5.15 16 9 16C12.85 16 16 12.85 16 9C16 5.15 12.85 2 9 2ZM13.83 6.2H11.8C11.59 5.29 11.24 4.52 10.82 3.68C12.08 4.17 13.2 5.01 13.83 6.2ZM9 3.4C9.56 4.24 10.05 5.15 10.33 6.2H7.67C7.95 5.22 8.44 4.24 9 3.4ZM3.61 10.4C3.47 9.98 3.4 9.49 3.4 9C3.4 8.51 3.47 8.02 3.61 7.6H5.99C5.92 8.09 5.92 8.51 5.92 9C5.92 9.49 5.99 9.91 5.99 10.4H3.61ZM4.17 11.8H6.2C6.41 12.71 6.76 13.48 7.18 14.32C5.92 13.83 4.8 12.99 4.17 11.8ZM6.2 6.2H4.17C4.87 5.01 5.92 4.17 7.18 3.68C6.76 4.52 6.41 5.29 6.2 6.2ZM9 14.6C8.44 13.76 7.95 12.85 7.67 11.8H10.33C10.05 12.78 9.56 13.76 9 14.6ZM10.61 10.4H7.39C7.32 9.91 7.25 9.49 7.25 9C7.25 8.51 7.32 8.09 7.39 7.6H10.68C10.75 8.09 10.82 8.51 10.82 9C10.82 9.49 10.68 9.91 10.61 10.4ZM10.82 14.32C11.24 13.55 11.59 12.71 11.8 11.8H13.83C13.2 12.99 12.08 13.83 10.82 14.32ZM12.08 10.4C12.15 9.91 12.15 9.49 12.15 9C12.15 8.51 12.08 8.09 12.08 7.6H14.46C14.6 8.02 14.67 8.51 14.67 9C14.67 9.49 14.6 9.98 14.46 10.4H12.08Z" fill="#CA2543" />
    </svg>
  )
}
...
export function EmailIconFilled() {
  return (
    <svg width="18" height="18" viewBox="0 0 18 18" fill="none" xmlns="http://www.w3.org/2000/svg">
      <path d="M9 11.5C8.54801 11.5 8.09602 11.3588 7.71047 11.0727L2 6.84375V12.75C2 13.4401 2.58762 14 3.3125 14H14.6875C15.4124 14 16 13.4404 16 12.75V6.84375L10.2906 11.0755C9.90508 11.3594 9.45117 11.5 9 11.5ZM2.44543 6.11719L8.24777 10.4167C8.69047 10.7448 9.31062 10.7448 9.75332 10.4167L15.5557 6.11719C15.8113 5.90885 16 5.58854 16 5.25C16 4.55964 15.4121 4 14.6875 4H3.3125C2.58762 4 2 4.55964 2 5.25C2 5.58854 2.16434 5.90885 2.44543 6.11719Z" fill="#CA2543" />
    </svg>
  )
}